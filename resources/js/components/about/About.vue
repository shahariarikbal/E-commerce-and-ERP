        ...
        <div class="about">
            <div class="about__body">
                <div class="about__image">
                    <div class="about__image-bg" :style="{ backgroundImage: 'url(' + ('/fontend/images/about-banner.jpg') + ')' }"></div>
                ...
                <div class="about__card">
                    ...
                    <div class="about__card-signature">
                        <img :src="'/fontend/images/signature.jpg'" width="160" height="55" alt="">
                    </div>
                </div>
            ...
            <div class="container container--max--xl">
                ...
                <div class="block-teammates__list">
                    <div class="owl-carousel">
                        <div class="block-teammates__item teammate" v-for="team in teams" :key="team.id">
                            <div class="teammate__avatar">
                                <img :src="'/team/' + team.avatar" alt="">
                            </div>
        ...
        <div class="block block-reviews">
            <div class="container">
                ...
                <div class="block-reviews__list">
                    <div class="owl-carousel">
                        <div class="block-reviews__item" v-for="testimonial in testimonials" :key="testimonial.id">
                            <div class="block-reviews__item-avatar">
                                <img :src="'/testimonial/' + testimonial.avatar" alt="">
                            </div>
