                                                                ...
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($webManufacturers as $webManufacturer)
                                                                        <label class="filter-list__item">
                                                                            ...
                                                                            <span class="filter-list__counter">{{ $webManufacturer->web_product_count }}</span>
                                                                ...
                                                                <div class="filter-list__list">
                                                                    @foreach($webBrands as $webBrand)
                                                                        <label class="filter-list__item">
                                                                            ...
                                                                            <span class="filter-list__counter">{{ $webBrand->web_product_count }}</span>
                            ...
                            <div class="products-view">
                                <div class="products-view__options view-options view-options--offcanvas--mobile">
                                    <div class="view-options__body">
                                        ...
                                        <div class="view-options__legend">Showing <span id="productCount">Top Rated</span> products</div>
                                    </div>
                                </div>
                                ...
                                <div class="products-view__list products-list products-list--grid--3" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content" id="initialProducts">
                                        @if(!empty($webTopRatedProducts))
                                            @foreach($webTopRatedProducts as $webBrandsProduct)
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    ...
                                                                    <a href="{{ url('/upcoming/product/details/'.$webBrandsProduct->id) }}" style="text-transform: capitalize">{{ $webBrandsProduct->name }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
