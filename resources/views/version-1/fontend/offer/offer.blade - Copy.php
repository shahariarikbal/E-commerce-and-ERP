                ...
                <div class="block-header__body">
                    <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" class="breadcrumb__item-link">Offers</a></li>
                            ...
                            <div class="products-view">
                                <div class="products-view__options view-options view-options--offcanvas--mobile">
                                    <div class="view-options__body">
                                        ...
                                        <div class="view-options__legend">Showing <span id="productCount">Offer</span> products</div>
                                    </div>
                                </div>
                                ...
                                <div class="products-view__list products-list products-list--grid--3" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content" id="initialProducts">
                                        @if(!empty($webOfferProducts))
                                            @foreach($webOfferProducts as $webBrandsProduct)
