                ...
                <div class="block-header__body">
                    <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" class="breadcrumb__item-link">Best Seller</a></li>

                            <li class="breadcrumb__title-safe-area" role="presentation"></li>
                        </ol>
                    </nav>

                    <h1 class="block-header__title">Best Seller Products</h1>
                </div>
            </div>
        </div>
...
{{--                                     <div class="products-list__content" id="initialProducts">
                                        @if(!empty($webBestSellerProducts))
                                            @foreach($webBestSellerProducts as $webBrandsProduct)
...
{{--                                 <div class="block block-brands block-brands--layout--columns-5-full">
    ...
    <script>
        ...
        function myFunction() {   
            ...
            $.ajax({
                url: "{{ url('/search-data-all-page/') }}/",
                data:{page:page , category:cat, minimum:min, maximum:max, subCategory:sub, manufacturer:man, condition:cond, brand:br},
                type: "GET",
                success: function (data) {
                    console.log(data);
