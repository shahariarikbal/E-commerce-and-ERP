    ...
    <div class="container">
        <div class="row one">
            ...
            <table width="100%">
                <tr>
                    <td align="center">
                        <img src="{{ asset('/fontend/') }}/logo.png" height="100" width="100" class="img-fluid">
                    </td>
                </tr>
            </table>
            <table width="100%" style="
                ...
                <tr>
                    <td align="left" style="width: 40%">
                        <h1 style="margin: 0; color: #2c0b75;">Diplomacy Key LLC</h1>
                    </td>
                    <td align="center" style="width: 20%">
                        <img src="{{ asset('/fontend/') }}/favicon.PNG" height="100" width="100" class="img-fluid" style="width: 33%;">
                    </td>
                    <td align="left" style="width: 40%">
                        <h1 style="margin: 0; color: #2c0b75;">Billing Invoice</h1>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered" width="100%">
                ...
                @php($shipping = 0)
                @php($tax = 0)
                @foreach($order->orderDetails as $key => $data)
                <tr>
                    <td>{{ ++$key }}</td>
                    <td style="width: 10%;"><img src="{{ public_path('product/'.$data->product->image) }}" class="img-fluid"></td>
                    <td>{{ $data->product->sku }}</td>
                    <th scope="row">{{ $data->product->name }}</th>
                    <td>{{ $data->product_qty }}</td>
                    <td>${{ $data->product_price }}</td>
                    <td>${{ $totalSum = $data->product_qty * $data->product_price }}</td>
                </tr>
                <?php $total = $total+$totalSum; ?>
                <?php $shipping = $shipping+$data->product->shipping_cost; ?>
                <?php $tax = $tax+$data->product->tax; ?>
