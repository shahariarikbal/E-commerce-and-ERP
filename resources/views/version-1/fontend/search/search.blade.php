                    ...
                    <div class="block-header__body">
                        <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                            <ol class="breadcrumb__list">
                                ...
                                <li class="breadcrumb__item breadcrumb__item--current breadcrumb__item--last" aria-current="page"><span class="breadcrumb__item-link">Search Products</span></li>

                                <li class="breadcrumb__title-safe-area" role="presentation"></li>
                            </ol>
                        </nav>

                        {{-- <h1 class="block-header__title">Search Products</h1> --}}
                    </div>
                </div>
            </div>
...
{{--                                                                             <li class="filter-categories__item filter-categories__item--parent">
                                                                            ...
                                                                            <span id="catId" class="input-check filter-list__input" onclick="myFunction()" >
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input sub_category" type="checkbox" name="cat" value="{{ $key }}">
                                                                                ...
                                                                                <span class="filter-list__title" for="{{ $key }}">{{ $category}} </span>
                                                                ...
                                                                <div class="filter-list">
                                                                    <div class="filter-list__list">
                                                                        @foreach($subcategories as $key => $subcategory)
                                                                            ...
                                                                            <label id="{{ $key }}" class="filter-list__item">
                                                                            <span id="subCatId" class="input-check filter-list__input"  onclick="myFunction()">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input sub_category" type="checkbox"  name="sub" value="{{ $key }}">
                                                                                    <span class="input-check__box"></span>
                                                                                    <span class="input-check__icon">
                                                                                        <svg width="9px" height="7px">
                                                                                            <path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg>
                                                                                ...
                                                                                <span class="filter-list__title">{{ $subcategory }} </span>
                                                                                {{-- <span class="filter-list__counter">{{ $subcategory->count() }}</span> --}}
                                                                            </label>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    @foreach($conditions as $key => $condition)
                                                                        ...
                                                                        <label onclick="myFunction()" class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" type="checkbox" name="cond" value="{{ $key }}">
                                                                                    <span class="input-check__box"></span>
                                                                                    <span class="input-check__icon">
                                                                                        <svg width="9px" height="7px">
                                                                                            <path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg>
                                                                            ...
                                                                            <span class="filter-list__title">{{ $condition }} </span>
                                                                ...
                                                                <div class="filter-list">
                                                                    <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                        ...
                                                                        <label onclick="myFunction()" class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" type="checkbox"  name="man" value="{{ $key }}">
                                                                            ...
                                                                            <span class="filter-list__title">{{ $manu }} </span>
{{--                                                                            <span class="filter-list__counter">{{ $webManufacturer->count() }}</span>--}}
                                                                            ...
                                                                            <label onclick="myFunction()" class="filter-list__item">
                                                                                <span class="input-check filter-list__input">
                                                                                    <span class="input-check__body">
                                                                                        ...
                                                                                        <input class="input-check__input" type="checkbox" name="br" value="{{ $key }}">
...
{{--                                         <div class="products-list__content" id="initialProducts">
                                            @if(!empty($searchProducts))
                                                ...
                                                @foreach($searchProducts as $webBrandsProduct)
    ...
    <script>
        ...
        function myFunction() {   
            ...
            $.ajax({
                url: "{{ url('/searchData') }}/",
                data:{search:search , category:cat, minimum:min, maximum:max, subCategory:sub, manufacturer:man, condition:cond, brand:br},
                type: "GET",
                success: function (data) {
                    console.log(data);
