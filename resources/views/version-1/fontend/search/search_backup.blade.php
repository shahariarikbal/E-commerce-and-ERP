...
{{--                                                                             <li class="filter-categories__item filter-categories__item--parent">
                                                                            ...
                                                                            <span id="catId" class="input-check filter-list__input" onclick="myFunction()" >
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input sub_category" type="checkbox" name="cat" value="{{ $category->id }}">
                                                                                ...
                                                                                <span class="filter-list__title" for="{{ $category->id }}">{{ $category->name }} </span>
...
{{--                                                                             <label class="filter-list__item">
                                                                            ...
                                                                            <label id="{{ $subcategories->id }}" class="filter-list__item">
                                                                            <span id="subCatId" class="input-check filter-list__input"  onclick="myFunction()">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input sub_category" type="checkbox"  name="sub" value="{{ $subcategories->id }}">
                                                                                    <span class="input-check__box"></span>
                                                                                    <span class="input-check__icon">
                                                                                        <svg width="9px" height="7px">
                                                                                            <path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg>
                                                                                ...
                                                                                <span class="filter-list__title">{{ $subcategories->name }} </span>
                                                                                {{-- <span class="filter-list__counter">{{ $subcategories->count() }}</span> --}}
                                                                            </label>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="filter-list">
                                                                    <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                        ...
                                                                        <label onclick="myFunction()" class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" type="checkbox"  name="man" value="{{ $webManufacturer->id }}">
                                                                            ...
                                                                            <label onclick="myFunction()" class="filter-list__item">
                                                                                <span class="input-check filter-list__input">
                                                                                    <span class="input-check__body">
                                                                                        ...
                                                                                        <input class="input-check__input" type="checkbox" name="br" value="{{ $webBrand->id }}">
                                ...
                                <div class="products-view">
                                    <div class="products-view__options view-options view-options--offcanvas--mobile">
                                        <div class="view-options__body">
                                            ...
                                            <div class="view-options__legend">Showing <span id="productCount">Search</span> products</div>
                                        </div>
                                    </div>
