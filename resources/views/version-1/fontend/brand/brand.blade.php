                                                            ...
                                                            <div class="filter-list">
                                                                <div class="filter-list__list">
                                                                    ...
                                                                    @foreach($productCategory as $category)
                                                                        ...
                                                                        <span class="filter-list__title" for="{{ isset($category->first()->category ) ? $category->first()->category->id : '' }}">{{ $category->first()->category ? $category->first()->category->name : '' }} </span>
{{--                                                                     <span class="filter-list__counter">{{ $category->product->count() }}</span>--}}
                                            ...
                                            <div class="widget-filters__item">
                                                <div class="filter filter--opened" data-collapse-item>
                                                    ...
                                                    <div id="priceId" class="filter__body" data-collapse-content onclick="myFunction()">
                                                        <div class="filter__container">
                                                            ...
                                                            <div class="filter-list">
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($data['manufactures'] as $manufacture)
                                                                        <label class="filter-list__item">
                                                                        <span class="input-check filter-list__input" onclick="myFunction()">
                                                                            <span class="input-check__body">
                                                                ...
                                                                <div class="filter-list__list">
                                                                    @foreach($data['brands'] as $brand)
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input" onclick="myFunction()">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" type="checkbox" name="br" value="{{ $brand->id }}">
                                                                                    <span class="input-check__box"></span>
                                                                                    <span class="input-check__icon">
                                                                                        <svg width="9px" height="7px">
                                                                                            <path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg>
