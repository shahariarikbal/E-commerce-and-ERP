    ...
    <div class="site__body">
        ...
        <div class="col-lg-12">
            <div class="col-12 mb-3">
                ...
                @endif
                <div class="alert alert-lg alert-primary">You have to login to complete the order. Please login. If you are not a registered user yet, please register first.</div>
            </div>
            <div class="row">
                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-lg-0">
                                            <div class="card-body card-body--padding--2">
                                                <h3 class="card-title">New to Diplomacy Key? Create Your New Account.</h3>
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label for="checkout-first-name">Name</label>
                                                        <input type="text" class="form-control" id="checkout-first-name" name="name" placeholder="First Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="street_address" id="checkout-street-address" placeholder="Street Address">
                                                </div>

                                                <div class="form-group">
                                                    <label for="checkout-address">Apartment, suite, unit etc. <span class="text-muted">(Optional)</span></label>
                                                    <input type="text" class="form-control" name="apartment" id="checkout-address">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="state" id="checkout-state">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="checkout-phone">Password</label>
                                                    <input type="password" class="form-control" name="password" id="checkout-phone" placeholder="Password">
                                                </div>
                                                <a href="#"><button type="submit" class="btn btn-primary btn-xl btn-block">Register</button></a>
                                            </div>
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="card mb-0">
                            <div class="card-body card-body--padding--2">
                                <h3 class="card-title">Log In here if you are already registered.</h3>
                                <div class="checkout__payment-methods payment-methods">
                                    <form action="{{ url('/customer/login') }}" method="post">
                                        ...
                                        <a href="#"><button type="submit" class="btn btn-primary btn-xl btn-block">Login</button></a>
                                    </form>
                                </div>
                            </div>
                        </div>
