                ...
                <div class="block-header__body">
                    <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" class="breadcrumb__item-link">New Arrival</a></li>

                            <li class="breadcrumb__title-safe-area" role="presentation"></li>
                        </ol>
                    </nav>

                    <h1 class="block-header__title">New Arrival Products</h1>
                </div>
            </div>
        </div>
...
{{--                                     <div class="products-list__content" id="initialProducts">
                                        @if(!empty($webNewArrivalProducts))
                                            @foreach($webNewArrivalProducts as $webBrandsProduct)
