                ...
                <div class="block-header__body">
                    <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" class="breadcrumb__item-link">Condition</a></li>

                            <li class="breadcrumb__title-safe-area" role="presentation"></li>
                        </ol>
                    </nav>

                    <h1 class="block-header__title">{{ $categoryWishProducts->name }} Condition Products</h1>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-list">
                                                                <div class="filter-list__list">
                                                                    @foreach($subcategoryWiseProducts as $subcategories)
                                                                        ...
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" {{ isset($isSelected) && $isSelected == $subcategories->subcategory->id ? 'checked' : '' }} type="checkbox" onclick="
                                                                                        document.getElementById('product'+{{$subcategories->subcategory->id }}).submit();" value="{{ $subcategories->subcategory->name }}">
                                                                            ...
                                                                            <form action="{{ url('/show/all/subcategory/filter/product/'.$subcategories->subcategory->id) }}" method="get" id="product{{ $subcategories->subcategory->id }}">
                                                                                @csrf
                                                                            </form>
                                                                        </label>
                                                                        @endif
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-list">
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($manufactureWiseProducts as $webManufacturer)
                                                                        ...
                                                                        <label class="filter-list__item">
                                                                            ...
                                                                            <form action="{{ url('/show/all/filter/product/'.$webManufacturer->webManufacture->id) }}" method="get" id="manufacture{{ $webManufacturer->webManufacture->id }}">
                                                                                @csrf
                                                                            </form>
                                                                        </label>
                                                                        @endif
                            ...
                            <div class="products-view">
                                <div class="products-view__options view-options view-options--offcanvas--mobile">
                                    <div class="view-options__body">
                                        ...
                                        <div class="view-options__legend">Showing <span id="productCount">{{ $categoryWishProducts->name }}</span> products</div>
                                    </div>
                                </div>
                                ...
                                <div class="products-view__list products-list products-list--grid--3" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content" id="initialProducts">
                                        @if(!empty($categoryWishProducts))
                                            @foreach($categoryWishProducts->products as $webBrandsProduct)
                                                    ...
                                                    <div class="product-card">
                                                        ...
                                                        <div class="product-card__image">
                                                            <a href="{{ url('/upcoming/product/details/'.$webBrandsProduct->id) }}">
                                                                <img src="{{ asset('/public/product/'.$webBrandsProduct->image) }}" alt="">
                                                            </a>
                                                        </div>
