                ...
                <div class="block-header__body">
                    <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" class="breadcrumb__item-link">Sub Categories</a></li>

                            <li class="breadcrumb__item breadcrumb__item--current breadcrumb__item--last" aria-current="page"><span class="breadcrumb__item-link">{{ isset($categoryWishProducts->name) ? $categoryWishProducts->name : '' }}</span></li>

                            <li class="breadcrumb__title-safe-area" role="presentation"></li>
                        </ol>
                    </nav>

                    <h1 class="block-header__title">{{ isset($categoryWishProducts->name) ? $categoryWishProducts->name :'' }}</h1>
                </div>
            </div>
        </div>
                                                                ...
                                                                <ul class="filter-categories__list">
                                                                    @foreach($webCategory as $category)
                                                                        <li class="filter-categories__item filter-categories__item--parent">
                                                                            ...
                                                                            <a href="{{ url('/category/wish/product/'.$category->category->id) }}">{{ $category->category->name }}</a>
                                                                            <div class="filter-categories__counter">{{ $category->category->product->count() }}</div>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-list">
                                                                <div class="filter-list__list">
                                                                    @foreach($subcategoriesWiseProduct as $subcategories)
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" {{ isset($isSelected) && $isSelected == $subcategories->subcategory->id ? 'checked' : '' }} type="checkbox" onclick="
                                                                                                                         document.getElementById('subcategory'+{{$subcategories->subcategory->id }}).submit();" value="{{ $subcategories->subcategory->name }}">
                                                                            ...
                                                                            <span class="filter-list__title">{{ $subcategories->subcategory->name }} </span>
                                                                            <span class="filter-list__counter">{{ $subcategories->subcategory->product->count() }}</span>
                                                                            <form action="{{ url('/show/all/subcategory/filter/product/'.$subcategories->subcategory->id) }}" method="get" id="subcategory{{ $subcategories->id }}">
                                                                                @csrf
                                                                            </form>
                                                                        </label>
                                                                    @endforeach
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-list">
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($manufactureWiseProduct as $webManufacturer)
                                                                        @if(isset($webManufacturer->webManufacture))
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" {{ isset($isManufactureSelected) && $isManufactureSelected == $webManufacturer->webManufacture->id ? 'checked' : '' }} type="checkbox" onclick="
                                                                                        document.getElementById('manufacture'+{{$webManufacturer->webManufacture->id }}).submit();" value="{{ $webManufacturer->webManufacture->name }}">
                                                                                    <span class="input-check__box"></span>
                                                                                    <span class="input-check__icon">
                                                                                        <svg width="9px" height="7px">
                                                                                            <path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg>
                                                                            ...
                                                                            <span class="filter-list__title">{{ $webManufacturer->webManufacture->name }} </span>
                                                                            <span class="filter-list__counter">{{ $webManufacturer->webManufacture->product->count() }}</span>
                                                                            <form action="{{ url('/show/car/manufacture/filter/product/'.$webManufacturer->webManufacture->id) }}" method="get" id="manufacture{{ $webManufacturer->webManufacture->id }}">
                                                                                @csrf
                                                                            </form>
                                                                        </label>
                                                                        @endif
                                                                ...
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($conditions as $condition)
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input">
                                                                                <span class="input-check__body">
                                                                                    <input class="input-check__input" {{ isset($isConditionSelected) && $isConditionSelected == $condition->id ? 'checked' : '' }} type="checkbox" onclick="
                            ...
                            <div class="products-view">
                                <div class="products-view__options view-options view-options--offcanvas--mobile">
                                    <div class="view-options__body">
                                        ...
                                        <div class="view-options__legend">Showing <span id="productCount">{{ isset($categoryWishProducts->webproduct_count) ? $categoryWishProducts->webproduct_count : '' }}</span> products</div>
                                    </div>
                                </div>
                                ...
                                <div class="products-view__list products-list products-list--grid--3" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content" id="initialProducts">
                                        @if(isset($categoryWishProducts->product))
                                        @foreach($categoryWishProducts->product as $categoryWishProduct)
                                            <div class="products-list__item">
                                                <div class="product-card">
                                                    <div class="product-card__actions-list">
                                                        
                                                        <button class="product-card__action product-card__action--wishlist addWiseList" data-id="{{ $categoryWishProduct->id }}" type="button" aria-label="Add to wish list"><svg width="16" height="16"><path d="M13.9,8.4l-5.4,5.4c-0.3,0.3-0.7,0.3-1,0L2.1,8.4c-1.5-1.5-1.5-3.8,0-5.3C2.8,2.4,3.8,2,4.8,2s1.9,0.4,2.6,1.1L8,3.7l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"/></svg>
                                                        </button>
                                                    </div>

                                                    <div class="product-card__image">
                                                        <a href="{{ url('/category/product/details/'.$categoryWishProduct->id) }}">
                                                            <img src="{{ asset('/public/product/'.$categoryWishProduct->image) }}" alt="">
                                                        </a>
                                                    </div>

                                                    <div class="product-card__info">
                                                        <div class="product-card__meta"><span class="product-card__meta-title">SKU:</span> {{ $categoryWishProduct->sku }}</div>

                                                        <div class="product-card__name">
                                                            <div>
                                                                <div class="product-card__badges">
                                                                    @if($categoryWishProduct->new)
                                                                    <div class="tag-badge tag-badge--new">{{ $categoryWishProduct->new }}</div>
                                                                    @endif
                                                                    @if($categoryWishProduct->sale)
                                                                        <div class="tag-badge tag-badge--sale">{{ $categoryWishProduct->sale }}</div>
                                                                    @endif
                                                                    @if($categoryWishProduct->hot)
                                                                    <div class="tag-badge tag-badge--hot">{{ $categoryWishProduct->hot }}</div>
                                                                    @endif
                                                                </div>
                                                                <a href="#" style="text-transform: capitalize">{{ $categoryWishProduct->name }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="product-card__footer">
                                                        <div class="product-card__prices">
                                                            <div class="product-card__price product-card__price--current">${{ number_format($categoryWishProduct->sale_price,2) }}</div>
                                                            <div class="product-card__price product-card__price--old">${{ number_format($categoryWishProduct->pre_price,2) }}</div>
                                                        </div>
                                                        <button class="product-card__addtocart-icon addCart" type="button" data-id="{{ $categoryWishProduct->id }}" aria-label="Add to cart"><svg width="20" height="20"><circle cx="7" cy="17" r="2"/><circle cx="15" cy="17" r="2"/><path d="M20,4.4V5l-1.8,6.3c-0.1,0.4-0.5,0.7-1,0.7H6.7c-0.4,0-0.8-0.3-1-0.7L3.3,3.9C3.1,3.3,2.6,3,2.1,3H0.4C0.2,3,0,2.8,0,2.6V1.4C0,1.2,0.2,1,0.4,1h2.5c1,0,1.8,0.6,2.1,1.6L5.1,3l2.3,6.8c0,0.1,0.2,0.2,0.3,0.2h8.6c0.1,0,0.3-0.1,0.3-0.2l1.3-4.4C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z"/></svg>
                                                        </button>

                                                        <button class="product-card__addtocart-full" type="button">Add to cart</button>

                                                        <button class="product-card__wishlist addWiseList" data-id="{{ $categoryWishProduct->id }}" type="button"><svg width="16" height="16"><path d="M13.9,8.4l-5.4,5.4c-0.3,0.3-0.7,0.3-1,0L2.1,8.4c-1.5-1.5-1.5-3.8,0-5.3C2.8,2.4,3.8,2,4.8,2s1.9,0.4,2.6,1.1L8,3.7l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"/></svg> <span>Add to wishlist</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
