                                                                ...
                                                                <ul class="filter-categories__list">
                                                                    @foreach($webCategory as $category)
                                                                        <li class="filter-categories__item filter-categories__item--parent">
                                                                            ...
                                                                            <div class="filter-categories__counter">{{ $category->webproduct_count }}</div>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-list">
                                                                <div class="filter-list__list"><label class="filter-list__item"></label>
                                                                    @foreach($webManufacturers as $webManufacture)
                                                                        <label class="filter-list__item">
                                                                            <span class="input-check filter-list__input"><span class="input-check__body"><input class="input-check__input" type="checkbox"> <span class="input-check__box"></span> <span class="input-check__icon"><svg width="9px" height="7px"><path d="M9,1.395L3.46,7L0,3.5L1.383,2.095L3.46,4.2L7.617,0L9,1.395Z"/></svg> </span></span></span>
                                                                            <span class="filter-list__title">{{ $webManufacture->name }} </span><span class="filter-list__counter">24</span>
                                                                        </label>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                            ...
                            <div class="products-view">
                                ...
                                <div class="products-view__list products-list products-list--grid--3" data-layout="grid" data-with-features="false">
                                    ...
                                    <div class="products-list__content">
                                        @foreach($webAllCategoryProducts as $webAllCategoryProduct)
                                            @foreach($webAllCategoryProduct->webproduct as $product)
                                            <div class="products-list__item">
                                                <div class="product-card">
                                                    ...
                                                    <div class="product-card__image">
                                                        <a href="{{ url('/category/product/details/'.$product->id) }}">
                                                    ...
                                                    <div class="product-card__info">
                                                        ...
                                                        <div class="product-card__name"><div><div class="product-card__badges"><div class="tag-badge tag-badge--sale">sale</div><div class="tag-badge tag-badge--hot">hot</div></div><a href="#">{{ $product->name }}</a></div></div>
                                                    ...
                                                    <div class="product-card__footer">
                                                        <div class="product-card__prices">
                                                            <div class="product-card__price product-card__price--current">${{ number_format($product->price,2) }}</div>
