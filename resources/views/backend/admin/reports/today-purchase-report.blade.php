                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <span style="font-size: 1.25rem; color: black">Today Purchase Report</span>
                                </div>
                                    ...
                                    <div class="dt-responsive table-responsive">
                                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                                            ...
                                            @foreach($purchase as $item)
                                                @foreach($item->purchaseProduct as $key => $info)
                                                    <tr>
                                                        <td>{{ $i++ }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a href="{{ url('/today/purchase/pdf/'.$item->id) }}" title="Purchase Pdf" class="dropdown-item btn btn-sm btn-success">
                                                                        PDF
                                                                    </a>
                                                                </div>
                                                            </div>
