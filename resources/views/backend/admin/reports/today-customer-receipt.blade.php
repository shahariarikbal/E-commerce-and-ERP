                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <span style="font-size: 1.25rem; color: black">Today Customer Receipt</span>
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                    <a href="{{ url('/today/receipt/view/'.$item->id) }}" title="Customer Pdf" class="dropdown-item btn btn-sm btn-success">
                                                                        Receipt
                                                                    </a>
                                                                </div>
                                                            </div>
