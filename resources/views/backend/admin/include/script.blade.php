...
<script  src="{{ asset('/backend/') }}/files/bower_components/jquery-ui/js/jquery-ui.min.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/popper.js/js/popper.min.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/bootstrap/js/bootstrap.min.js"></script>

<script  src="{{ asset('/backend/') }}/files/bower_components/jquery-slimscroll/js/jquery.slimscroll.js"></script>

<script  src="{{ asset('/backend/') }}/files/bower_components/modernizr/js/modernizr.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/modernizr/js/css-scrollbars.js"></script>
...
<script  src="{{ asset('/backend/') }}/files/bower_components/i18next/js/i18next.min.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
<script  src="{{ asset('/backend/') }}/files/bower_components/jquery-i18next/js/jquery-i18next.min.js"></script>
...
<script  src="{{ asset('/backend/') }}/files/assets/js/script.js"></script>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="07368336ca50d7f5e6e6915e-|49" defer=""></script>
<!--Toastr Message Js-->
