    ...
    <div class="container">
        <div class="row one">
            ...
            <table width="100%">
                <tr class="three">
                    <td align="left" style="width: 50%;vertical-align: top;">
                        <h5>INVOICE NO: #{{ isset($supplier->invoice_no) ? $supplier->invoice_no : '' }}</h5>
                    </td>
                    <td align="right" style="width: 50%;vertical-align: top;">
                        <h5>DATE: {{ date('m-d-Y', strtotime( isset($supplier->created_at) ? $supplier->created_at : '')) }}</h5>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%">
                <tr class="three">
                    ...
                    <td align="left" style="width: 40%;vertical-align: top;">
                        ...
                        <p>CONTACT NUMBER: {{ $supplier->mobile_no_one }}</p>
                        <p>ADDRESS: {{ $supplier->address_one }}</p>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered" width="100%">
                ...
                <tbody>
                <tr>
                    <td>{{ isset($supplier->balance) ? $supplier->balance : '' }}</td>
                    <td>${{ isset($supplier->daily_paid) ? $supplier->daily_paid : '' }}</td>
                    <td>
                        @if(isset($supplier->balance) && isset($supplier->daily_paid))
                            ${{ $grandTotal = $supplier->balance - $supplier->daily_paid }}
                        @endif
                    </td>
                </tr>
                </tbody>
            ...
            <table width="100%" style="padding-top: 40px;">
                <tr class="three">
                    <td align="left" style="width: 30%;vertical-align: top;">
                        ...
                        <h5 style="margin: 8px 0px;">DATE: {{ date('m-d-Y', strtotime($supplier->created_at)) }}</h5>
                    </td>
                    ...
                    <td align="left" style="width: 30%; margin: 8px 0px;">
                        ...
                        <h5 style="margin: 8px 0px;">{{ isset($supplier->name) ? $supplier->name : '' }}</h5>
                        <h5 style="
									    border-top: 2px solid #676666;
									    padding-top: 8px;margin: 0;
									">CUSTOMER'S SIGNATURE</h5>
                        <h5 style="margin: 8px 0px;">DATE: {{ isset($supplier->created_at) ? date('m-d-Y', strtotime($supplier->created_at)) : '' }}</h5>
                    </td>
                </tr>
            </table>
        </div>
